...
public interface UserBasicInfoMapper {
    ...
    @Insert("insert into user_basic_info(username, age, gender, birth_date,email, phone, qq, introduction, avator, create_time,update_time) "+
            "VALUES (#{username},#{age},#{gender},#{email},#{birthDate},#{phone},#{qq},#{introduction},#{avator},#{createTime},#{updateTime})")
